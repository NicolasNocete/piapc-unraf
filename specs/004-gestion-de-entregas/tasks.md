...
- [ ] **T-007:** Incorporar la nota diagnostica privada de 1 a 10 en devoluciones, acciones, consultas y UI docente, sin exponerla al estudiante. Referencias: FR-017, FR-018; AC-010. Verificacion: migracion, pruebas de autorizacion, `npm run check` y flujo docente/estudiante.
