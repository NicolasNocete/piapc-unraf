...
- **FR-017:** Al publicar una devolucion evaluable, el profesor responsable debe asignar una nota entera de 1 a 10. Si el material entregado no es accesible, puede publicar una devolucion que explique la situacion sin nota numerica; ese motivo queda registrado en la revision docente para mantener trazabilidad.
...
- **AC-010 (FR-017, FR-018):** Dado un profesor responsable que publica una devolucion evaluable, cuando asigna una nota entera entre 1 y 10, la revision conserva texto y nota; el profesor responsable puede ver ambos y el estudiante solo puede ver el texto. Dado material inaccesible, el profesor puede publicar el texto de la devolucion sin nota y con el motivo interno correspondiente; el estudiante solo recibe el texto.
