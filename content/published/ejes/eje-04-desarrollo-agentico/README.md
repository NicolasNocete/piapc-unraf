...
Se utilizará el laboratorio [Guardia de Sigilo](https://github.com/NicolasNocete/piapc-guardia-sigilo), preparado para Phaser, o un proyecto equivalente en Unity u otro entorno. Los materiales históricos del workspace no forman parte de las consignas ni de las soluciones.
